...
public class FrameApp extends Application implements AFApp {
	public  final static String AppName = "Funny Frames";
	public  final static String AppNameNoSpace = "Funny_Frames_for_Free";
	public final static String AppId = "com.androidfuture.funnyframes";
	public static final String AppHttpUrl = "https://market.android.com/details?id=com.androidfuture.funnyframes";
	public final static String MY_AD_ID = "a15155b0998c94f" ;
